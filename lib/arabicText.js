...
arabicMessages = {
    ...
    maleLabel: 'ذكر',
    femaleLabel: 'أنثى',
    enterNewPasswd:"أدخل كلمة السر الجديدة",
    userNameLabel: 'اسم المستخدم',
    alertLeaveFromTouched: "عفواً.. هل أنت متأكد من إغلاق الصفحة قبل انهاء العملية؟",
...
//layout page
    ...
    usedUsername:"اسم المستخدم موجود مسبقاً",
    headers: {
        add: 'إضافة موضوع',
        edit: 'تعديل الموضوع',
        read: 'مشاهدة',
...
SimpleSchema.messages({
    ...
    badDate: "[label] ليس تاريخاً صحيحاً",
